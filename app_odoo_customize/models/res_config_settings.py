...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url',
                                                    default='https://www.einfo-tech.com')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url',
                                                        default='https://www.einfo-tech.com')
        app_support_url = ir_config.get_param('app_support_url', default='https://www.einfo-tech.com')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='https://www.einfo-tech.com')
        app_enterprise_url = ir_config.get_param('app_enterprise_url', default='https://www.einfo-tech.com')
        res.update(
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_documentation_url",
                            self.app_documentation_url or "https://www.einfo-tech.com")
        ir_config.set_param("app_documentation_dev_url",
                            self.app_documentation_dev_url or "https://www.einfo-tech.com")
        ir_config.set_param("app_support_url", self.app_support_url or "https://www.einfo-tech.com")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "https://www.einfo-tech.com")
        ir_config.set_param("app_enterprise_url", self.app_enterprise_url or "https://www.einfo-tech.com")
